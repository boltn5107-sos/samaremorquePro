...
class DepanneurInterventionController extends Controller
{
    ...
    public function incoming()
    {
        ...
        return view('depanneur.demands', compact('interventions'));
    }
    ...
    public function index()
    {
        ...
        return view('depanneur.interventions', compact('interventions'));
    }
    ...
    public function show(Intervention $intervention)
    {
        ...
        return view('depanneur.intervention-detail', compact('intervention'));
    }
