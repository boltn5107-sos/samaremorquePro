                        ...
                        <dl class="space-y-3 text-sm">
                            ...
                            @if($intervention->client_lat && $intervention->client_lng && $intervention->destination_lat && $intervention->destination_lng)
                                <div>
                                    ...
                                    <dd class="mt-1.5">
                                        <a href="{{ gmaps_route_url($intervention) }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg text-white bg-[#4285F4] hover:bg-[#3367D6] transition-colors shadow-sm shadow-blue-500/20">
