                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">
                            <span class="font-mono">{{ $intervention->tracking_code }}</span>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="card p-6">
                        ...
                        <dl class="space-y-4 text-sm">
                            ...
                            @if($intervention->photo)
                                <div>
                                    <dt class="text-slate-500 flex items-center gap-1.5 mb-1.5"><x-icon name="camera" class="w-4 h-4" /> Photo de la panne</dt>
                                    <a href="{{ asset('storage/' . $intervention->photo) }}" target="_blank" rel="noopener">
                                        <img src="{{ asset('storage/' . $intervention->photo) }}" alt="Photo de la panne" class="w-full rounded-xl border border-slate-200">
                                    </a>
                                </div>
                            @endif
                            @if($intervention->professional)
                                <div class="pt-3 border-t border-slate-200">
                                    ...
                                    <div class="flex gap-2 mt-3">
                                        ...
                                        <a href="{{ $whatsapp }}" target="_blank" rel="noopener" class="px-4 py-2 text-sm font-semibold rounded-xl text-white bg-emerald-600 hover:bg-emerald-700 inline-flex items-center justify-center gap-2 transition-all">
