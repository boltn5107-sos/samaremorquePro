...
<head>
    ...
    <link rel="canonical" href="{{ url('/depannage-dakar') }}">
    <link rel="alternate" hreflang="fr" href="{{ url('/depannage-dakar') }}">
    <link rel="alternate" hreflang="fr-SN" href="{{ url('/depannage-dakar') }}">
    <link rel="alternate" hreflang="x-default" href="{{ url('/depannage-dakar') }}">
    ...
    <meta property="og:url" content="{{ url('/depannage-dakar') }}">
    ...
    <main>
        <header class="relative bg-slate-900 text-white overflow-hidden">
            <div class="absolute inset-0">
                <img src="{{ asset('images/remorque_qui_transporte_un_vehicule.jpg') }}" alt="Depannage et remorquage a Dakar" class="w-full h-full object-cover opacity-30">
        ...
        <section id="services" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-10 text-center">
                    <a href="{{ route('guest.create') }}" class="btn-primary text-base px-8 py-3.5">Demander un depannage</a>
                </div>
            </div>
        </section>
