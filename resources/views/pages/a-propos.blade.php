...
<head>
    ...
    <link rel="alternate" hreflang="fr" href="{{ url('/a-propos') }}">
    <link rel="alternate" hreflang="fr-SN" href="{{ url('/a-propos') }}">
    <link rel="alternate" hreflang="x-default" href="{{ url('/a-propos') }}">
        ...
        <section class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <img src="{{ asset('images/remorque_qui_transporte_un_vehicule.jpg') }}" alt="Remorqueur au Senegal" class="rounded-2xl shadow-lg object-cover w-full">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-slate-900 text-white">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="mt-8 flex flex-col sm:flex-row justify-center gap-3">
                    ...
                    <a href="{{ route('register') }}" class="btn-secondary bg-white/10 text-white border-white/20 hover:bg-white/20 text-base px-6 py-3.5">Devenir professionnel</a>
                </div>
            </div>
        </section>
    </main>
