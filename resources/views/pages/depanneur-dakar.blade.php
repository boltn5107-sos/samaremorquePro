...
<head>
    ...
    <link rel="canonical" href="{{ url('/depanneur-dakar') }}">
    <link rel="alternate" hreflang="fr" href="{{ url('/depanneur-dakar') }}">
    <link rel="alternate" hreflang="fr-SN" href="{{ url('/depanneur-dakar') }}">
    <link rel="alternate" hreflang="x-default" href="{{ url('/depanneur-dakar') }}">
    ...
    <meta property="og:url" content="{{ url('/depanneur-dakar') }}">
    ...
    <main>
        <header class="relative bg-slate-900 text-white overflow-hidden">
            <div class="absolute inset-0">
                <img src="{{ asset('images/remorque_qui_transporte_un_vehicule.jpg') }}" alt="Depanneur Dakar" class="w-full h-full object-cover opacity-30">
