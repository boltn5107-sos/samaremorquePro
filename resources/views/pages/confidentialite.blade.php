@extends('layouts.app')
@section('title', 'Politique de confidentialite - SamaRemorque')
@section('content')
    ...
    <section class="relative overflow-hidden reveal py-16 bg-white">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <p class="mt-2 text-sm text-slate-500">Derniere mise a jour : {{ now()->translatedFormat('d F Y') }}.</p>
            ...
            <div class="mt-10 pt-6 border-t border-slate-200 text-sm text-center text-slate-500">
                ...
                <a href="{{ url('/') }}" class="ml-2 text-orange-600 hover:text-orange-700">Retour a l'accueil</a>
            </div>
        </div>
    </section>
@endsection