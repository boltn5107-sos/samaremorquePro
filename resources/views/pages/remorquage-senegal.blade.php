@extends('layouts.app')
@section('title', 'Remorquage Senegal - SamaRemorque | Remorqueur partout au Senegal')
@section('content')
    ...
    <section id="zones" class="relative overflow-hidden reveal py-16 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                ...
                <a href="{{ route('guest.create') }}" class="card p-4 text-center hover:border-orange-300"><p class="font-semibold text-slate-900">Thie's</p><p class="text-xs text-slate-500">Remorquage & depannage</p></a>
            </div>
        </div>
    </section>
