                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="flex items-center gap-1.5 text-sm text-slate-600">
                                        ...
                                        <a href="tel:{{ $intervention->client->phone }}" class="hover:text-orange-600">{{ $intervention->client->phone }}</a>
                                    </p>
                                    <div class="flex gap-2 pt-1">
                                        ...
                                        <a href="{{ $cWhatsapp }}" target="_blank" rel="noopener" class="px-3 py-1 text-xs font-semibold rounded-md text-white bg-emerald-600 hover:bg-emerald-700 inline-flex items-center gap-1.5">
