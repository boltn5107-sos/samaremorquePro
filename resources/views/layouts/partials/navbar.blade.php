            ...
            <div class="hidden md:flex items-center gap-6 text-sm font-medium">
                @auth
                    @if(Auth::user()->isClient())
                        ...
                        <a href="{{ route('client.intervention.index') }}" class="flex items-center gap-1.5 hover:text-orange-400"><x-icon name="car" class="w-4 h-4" /> Mes interventions</a>
                    ...
                    @elseif(Auth::user()->isAdmin())
                        ...
                        <a href="{{ route('admin.professionnels.index') }}" class="flex items-center gap-1.5 hover:text-orange-400"><x-icon name="user" class="w-4 h-4" /> Professionnels</a>
                    @endif
        ...
        <div class="px-4 py-3 space-y-1 text-sm font-medium">
            @auth
                @if(Auth::user()->isClient())
                    ...
                    <a href="{{ route('client.intervention.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-slate-800"><x-icon name="car" class="w-4 h-4" /> Mes interventions</a>
                @elseif(Auth::user()->isRemorqueur())
                ...
                @elseif(Auth::user()->isAdmin())
                    ...
                    <a href="{{ route('admin.professionnels.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-slate-800"><x-icon name="user" class="w-4 h-4" /> Professionnels</a>
                @endif
