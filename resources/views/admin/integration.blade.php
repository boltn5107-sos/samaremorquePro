        ...
        <div class="card p-6">
            ...
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                ...
                <div class="sm:col-span-2">
                    ...
                    <dd class="font-mono text-xs bg-slate-50 rounded-lg p-2 mt-1">{{ url('/webhook/wave') }}</dd>
                </div>
            </dl>
        </div>
...
WAVE_WEBHOOK_SECRET=&lt;webhook_secret&gt;</code></pre>
        ...
        <div class="card p-6">
            ...
            <ol class="list-decimal list-inside space-y-3 text-sm text-slate-700">
                ...
                <li>Ajoutez l'URL : <code class="bg-slate-100 px-2 py-0.5 rounded">{{ url('/webhook/wave') }}</code></li>
