                    ...
                    <dl class="space-y-3 text-sm">
                        <div>
                            ...
                            <dd class="mt-1 flex flex-wrap gap-1.5">
                                ...
                                <a href="{{ $clWa }}" target="_blank" rel="noopener" class="px-3 py-1 text-xs font-semibold rounded-md text-white bg-emerald-600 hover:bg-emerald-700 inline-flex items-center gap-1.5 {{ $intervention->client_phone ? '' : 'pointer-events-none opacity-50' }}">
