...
<head>
    ...
    <link rel="canonical" href="<?php echo e(url('/remorquage-dakar')); ?>">
    <link rel="alternate" hreflang="fr" href="<?php echo e(url('/remorquage-dakar')); ?>">
    <link rel="alternate" hreflang="fr-SN" href="<?php echo e(url('/remorquage-dakar')); ?>">
    <link rel="alternate" hreflang="x-default" href="<?php echo e(url('/remorquage-dakar')); ?>">
    ...
    <meta property="og:url" content="<?php echo e(url('/remorquage-dakar')); ?>">
    ...
    <main>
        <header class="relative bg-slate-900 text-white overflow-hidden">
            <div class="absolute inset-0">
                <img src="<?php echo e(asset('images/remorque_qui_transporte_un_vehicule.jpg')); ?>" alt="Remorquage a Dakar" class="w-full h-full object-cover opacity-30">
        ...
        <section id="services" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-10 text-center">
                    <a href="<?php echo e(route('guest.create')); ?>" class="btn-primary text-base px-8 py-3.5">Demander un remorquage</a>
                </div>
            </div>
        </section>
...
<?php /**PATH C:\xampp\htdocs\samaRemorque\senegal-towing\resources\views\pages\remorquage-dakar.blade.php ENDPATH**/ ?>