...
<?php endif; ?>
                Detail intervention #<?php echo e($intervention->id); ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?> Client</dt>
                            <dd class="font-medium text-slate-900"><?php echo e($intervention->client_name); ?></dd>
                            <dd class="mt-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($intervention->isGuest()): ?>
                                    <span class="badge bg-orange-100 text-orange-700">Demande sans compte (<?php echo e($intervention->tracking_code); ?>)</span>
                                <?php else: ?>
                                    <span class="badge bg-emerald-100 text-emerald-700">Client inscrit</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </dd>
                            <?php
                                $clPhone = preg_replace('/[^0-9]/', '', $intervention->client_phone ?? '');
...
<?php $component = $__componentOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?> <?php echo e($intervention->client_phone ?? 'Numero non renseigne'); ?>

                                </a>
                                <a href="<?php echo e($clWa); ?>" target="_blank" rel="noopener" class="px-3 py-1 text-xs font-semibold rounded-md text-white bg-emerald-600 hover:bg-emerald-700 inline-flex items-center gap-1.5 <?php echo e($intervention->client_phone ? '' : 'pointer-events-none opacity-50'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\samaRemorque\senegal-towing\resources\views/admin/intervention-detail.blade.php ENDPATH**/ ?>