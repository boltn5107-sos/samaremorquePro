...
<head>
    ...
    <link rel="alternate" hreflang="fr" href="<?php echo e(url('/')); ?>">
    <link rel="alternate" hreflang="fr-SN" href="<?php echo e(url('/')); ?>">
...
<body class="font-sans antialiased bg-white text-slate-900">
    ...
    <section id="zones" class="py-14 bg-slate-50 border-b border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('guest.create')); ?>" class="card p-4 text-center hover:border-orange-300">
                        <p class="font-semibold text-slate-900"><?php echo e($zone['name']); ?></p>
                        <p class="text-xs text-slate-500"><?php echo e($zone['desc']); ?></p>
                    </a>
    ...
    <section id="suivi" class="py-14 bg-slate-900 text-white border-t border-slate-800">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <form method="POST" action="<?php echo e(route('guest.search')); ?>" class="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
                <?php echo csrf_field(); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1">
                    ...
                    <div class="mt-8">
                        <a href="<?php echo e(route('guest.create')); ?>" class="btn-primary">Demander une assistance</a>
                    </div>
                </div>
    ...
    <section id="professionnels" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <img src="<?php echo e(asset('images/clients_qui_utilise_l_application3.jpg')); ?>"
    ...
    <section class="py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <a href="<?php echo e(route('seo.depannage-dakar')); ?>" class="card p-6 hover:border-orange-300">
                ...
                <a href="<?php echo e(route('seo.remorquage-dakar')); ?>" class="card p-6 hover:border-orange-300">
                ...
                <a href="<?php echo e(route('seo.depannage-urgence-dakar')); ?>" class="card p-6 hover:border-orange-300">
                ...
                <a href="<?php echo e(route('seo.depanneur-dakar')); ?>" class="card p-6 hover:border-orange-300">
                ...
                <a href="<?php echo e(route('seo.remorquage-senegal')); ?>" class="card p-6 hover:border-orange-300">
                ...
                <a href="<?php echo e(route('guest.create')); ?>" class="card p-6 hover:border-orange-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="<?php echo e(route('guest.create')); ?>" class="hover:text-orange-400">Demander une assistance</a></li>
                        <li><a href="#suivi" class="hover:text-orange-400">Suivre une demande</a></li>
                        <li><a href="<?php echo e(route('seo.depannage-dakar')); ?>" class="hover:text-orange-400">Depannage Dakar</a></li>
                        <li><a href="<?php echo e(route('seo.remorquage-dakar')); ?>" class="hover:text-orange-400">Remorquage Dakar</a></li>
                        <li><a href="<?php echo e(route('seo.depannage-urgence-dakar')); ?>" class="hover:text-orange-400">Depannage urgence Dakar</a></li>
                        <li><a href="<?php echo e(route('seo.depanneur-dakar')); ?>" class="hover:text-orange-400">Depanneur Dakar</a></li>
                        <li><a href="<?php echo e(route('seo.remorquage-senegal')); ?>" class="hover:text-orange-400">Remorquage Senegal</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="<?php echo e(route('seo.guide-depannage-dakar')); ?>" class="hover:text-orange-400">Guide depannage Dakar</a></li>
                        <li><a href="<?php echo e(route('about')); ?>" class="hover:text-orange-400">A propos</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-orange-400">Contact</a></li>
