...
<?php $__env->startSection('title', 'Politique de confidentialite - SamaRemorque'); ?>
<?php $__env->startSection('content'); ?>
    <section class="relative overflow-hidden reveal py-24 lg:py-32 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-4xl font-extrabold tracking-tight">Politique de confidentialite</h1>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moradmin\Desktop\samaremorquePro-main\samaremorquePro-main\resources\views\pages\confidentialite.blade.php ENDPATH**/ ?>