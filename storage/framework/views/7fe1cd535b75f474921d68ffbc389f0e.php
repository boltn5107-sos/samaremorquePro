...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-hero','data' => ['title' => 'Contact','subtitle' => 'Une question ou une suggestion ? L\'équipe SamaRemorque vous répond.','eyebrow' => 'Support']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Contact','subtitle' => 'Une question ou une suggestion ? L\'équipe SamaRemorque vous répond.','eyebrow' => 'Support']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moradmin\Desktop\samaremorquePro-main\samaremorquePro-main\resources\views\pages\contact.blade.php ENDPATH**/ ?>