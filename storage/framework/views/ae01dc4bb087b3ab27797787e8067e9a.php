...
<?php $__env->startSection('title', 'Tableau de bord remorqueur'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'truck','class' => 'w-7 h-7']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'truck','class' => 'w-7 h-7']); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">
                            Bienvenue, <?php echo e(Auth::user()->first_name ?? Auth::user()->name); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        <p class="text-3xl font-bold text-slate-900"><?php echo e($pendingDemands->count()); ?></p>
...
<?php endif; ?>
                    ...
                    <div>
                        <p class="text-3xl font-bold text-slate-900"><?php echo e($completedInterventions->count()); ?></p>
                        <p class="text-sm text-slate-500">Interventions terminées</p>
                    </div>
                </div>

                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex items-center gap-4">
                    <span class="flex-shrink-0 w-12 h-12 rounded-xl <?php echo e($activeIntervention ? 'bg-sky-100 text-sky-600' : 'bg-slate-100 text-slate-400'); ?> flex items-center justify-center">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'map','class' => 'w-6 h-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'map','class' => 'w-6 h-6']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        <p class="text-3xl font-bold text-slate-900"><?php echo e($activeIntervention ? 1 : 0); ?></p>
...
<?php endif; ?>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="font-semibold text-slate-900 truncate"><?php echo e($activeIntervention->client_name); ?></p>
                                </div>
                            </div>
                            <div class="bg-slate-50 rounded-xl p-3.5 flex items-start gap-3">
...
<?php endif; ?>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="font-semibold text-slate-900 truncate"><?php echo e($activeIntervention->destination); ?></p>
                                </div>
                            </div>
                            <div class="bg-slate-50 rounded-xl p-3.5 flex items-start gap-3">
...
<?php endif; ?>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="font-semibold text-slate-900 truncate"><?php echo e(ucfirst($activeIntervention->service_type)); ?></p>
                                </div>
                            </div>
                            <div class="bg-slate-50 rounded-xl p-3.5 flex items-start gap-3">
...
<?php endif; ?>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="font-semibold text-slate-900 truncate"><?php echo e($activeIntervention->tracking_code); ?></p>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo e(route('remorqueur.intervention.show', $activeIntervention)); ?>" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold rounded-xl shadow-md shadow-orange-500/25 transition-all duration-300">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'map','class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingDemands->count()): ?>
                            <span class="px-2.5 py-1 text-xs font-bold rounded-full bg-orange-100 text-orange-700"><?php echo e($pendingDemands->count()); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                    <div class="flex items-start gap-3 min-w-0">
                                        ...
                                        <div class="min-w-0 space-y-0.5">
                                            <p class="font-semibold text-slate-900 truncate"><?php echo e(ucfirst($demand->service_type)); ?></p>
...
<?php endif; ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('remorqueur.intervention.reject', $demand)); ?>" onsubmit="if(!confirm('Confirmer le refus de cette demande ?')) return false; var b=this.querySelector('button'); b.disabled=true; b.classList.add('opacity-50');">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($completedInterventions->count()): ?>
                            <span class="px-2.5 py-1 text-xs font-bold rounded-full bg-emerald-100 text-emerald-700"><?php echo e($completedInterventions->count()); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <ul class="divide-y divide-slate-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $completedInterventions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intervention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <li class="p-5 hover:bg-slate-50/70 transition-colors duration-200">
...
<?php endif; ?>
                                    ...
                                    <div class="min-w-0 space-y-0.5">
                                        <p class="font-semibold text-slate-900 truncate"><?php echo e(ucfirst($intervention->service_type)); ?></p>
                                        <p class="text-sm text-slate-500 truncate"><?php echo e($intervention->destination); ?></p>
                                        <p class="text-xs text-slate-400"><?php echo e($intervention->created_at->format('d/m/Y H:i')); ?></p>
                                    </div>
                                </div>
                            </li>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moradmin\Desktop\samaremorquePro-main\samaremorquePro-main\resources\views/remorqueur/dashboard.blade.php ENDPATH**/ ?>