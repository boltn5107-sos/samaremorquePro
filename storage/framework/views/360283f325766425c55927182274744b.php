<?php $__env->startSection('title', 'Depannage urgence Dakar - SamaRemorque | Depanneur urgent 24/7 a Dakar'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-hero','data' => ['title' => 'Dépannage urgence à Dakar : intervention rapide 24/7','subtitle' => 'En cas de panne à Dakar, Pikine ou Rufisque, trouvez un dépanneur vérifié en quelques minutes. Intervention rapide, tarif transparent, suivi en temps réel.','eyebrow' => 'Dépannage urgence Dakar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dépannage urgence à Dakar : intervention rapide 24/7','subtitle' => 'En cas de panne à Dakar, Pikine ou Rufisque, trouvez un dépanneur vérifié en quelques minutes. Intervention rapide, tarif transparent, suivi en temps réel.','eyebrow' => 'Dépannage urgence Dakar']); ?>
...
<section id="services" class="py-20 md:py-28 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12">
            <a href="<?php echo e(route('guest.create')); ?>" class="landing-cta-primary !inline-flex">Demander un dépannage urgent</a>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moradmin\Desktop\samaremorquePro-main\samaremorquePro-main\resources\views\pages\depannage-urgence-dakar.blade.php ENDPATH**/ ?>