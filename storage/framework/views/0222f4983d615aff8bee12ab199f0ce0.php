...
<?php endif; ?>
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900"><?php echo e($client->full_name); ?></h1>
                        <p class="text-sm text-slate-500">Detail du compte client</p>
                    </div>
                </div>
                <a href="<?php echo e(route('admin.clients.index')); ?>" class="btn-secondary">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center gap-4 mb-6 p-4 rounded-xl bg-slate-50 border border-slate-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($client->photo): ?>
                                <img src="<?php echo e(asset('storage/' . $client->photo)); ?>" alt="" class="w-16 h-16 rounded-full object-cover bg-slate-100">
                            <?php else: ?>
                            ...
                            <div>
                                <p class="text-lg font-bold text-slate-900"><?php echo e($client->full_name); ?></p>
                                <span class="badge <?php echo e($client->is_active ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'); ?> mt-1">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <p class="text-sm font-semibold text-slate-900"><?php echo e($client->email); ?></p>
                            </div>
                            <div>
                                ...
                                ?>
                                <p class="text-sm font-semibold text-slate-900"><?php echo e($client->phone); ?></p>
...
<?php endif; ?> Appeler
                                    ...
                                    <a href="<?php echo e($clWa); ?>" target="_blank" rel="noopener" class="px-3 py-1 text-xs font-semibold rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 inline-flex items-center gap-1.5">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-slate-900"><?php echo e($client->created_at->format('d/m/Y')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moradmin\Desktop\samaremorquePro-main\samaremorquePro-main\resources\views\admin\client-detail.blade.php ENDPATH**/ ?>