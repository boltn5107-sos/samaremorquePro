...
<?php endif; ?>
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900">Detail intervention #<?php echo e($intervention->id); ?></h1>
...
<?php endif; ?>
                        ...
                        <div id="map" style="height: 420px; width: 100%;" class="rounded-xl border border-slate-200"></div>
                    </div>
                </div>
...
<?php endif; ?> <?php echo e($intervention->client_phone ?? 'Numero non renseigne'); ?>
                                    ...
                                    <a href="<?php echo e($clWa); ?>" target="_blank" rel="noopener" class="px-3 py-1 text-xs font-semibold rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 inline-flex items-center gap-1.5 <?php echo e($intervention->client_phone ? '' : 'pointer-events-none opacity-50'); ?>">
...
<?php endif; ?> Photo de la panne</dt>
                                    <a href="<?php echo e(asset('storage/' . $intervention->photo)); ?>" target="_blank" rel="noopener">
                                        <img src="<?php echo e(asset('storage/' . $intervention->photo)); ?>" alt="Photo de la panne" class="mt-1.5 w-full max-w-xs rounded-xl border border-slate-200">
                                    </a>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </dl>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moradmin\Desktop\samaremorquePro-main\samaremorquePro-main\resources\views\admin\intervention-detail.blade.php ENDPATH**/ ?>