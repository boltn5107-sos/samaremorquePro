<?php $__env->startSection('title', 'Guide depannage Dakar - SamaRemorque | Conseils et bons reflexes en cas de panne'); ?>
<?php $__env->startSection('content'); ?>
    <header class="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        <div class="absolute inset-0">
            <img src="<?php echo e(asset('images/remorque_qui_transporte_un_vehicule.jpg')); ?>" alt="Guide depannage Dakar" class="w-full h-full object-cover opacity-30">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\moradmin\Desktop\samaremorquePro-main\samaremorquePro-main\resources\views\pages\guide-depannage-dakar.blade.php ENDPATH**/ ?>