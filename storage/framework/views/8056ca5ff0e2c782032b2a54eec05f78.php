        ...
        <div class="flex items-center gap-4 mb-6">
            <div class="relative">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->photo): ?>
                    <img src="<?php echo e(asset('storage/' . Auth::user()->photo)); ?>" alt="" class="w-20 h-20 rounded-full object-cover bg-slate-100 border-2 border-orange-200">
                <?php else: ?>
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900"><?php echo e(Auth::user()->full_name); ?></h1>
        ...
        <div class="space-y-6">
            ...
            <div class="card p-6">
                <h2 class="text-lg font-semibold text-slate-900 mb-4 flex items-center gap-2">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'camera','class' => 'w-5 h-5 text-orange-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'camera','class' => 'w-5 h-5 text-orange-500']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('profile.photo')); ?>" enctype="multipart/form-data" class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <?php echo csrf_field(); ?>
                ...
                <form method="POST" action="<?php echo e(route('profile.update')); ?>" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="first_name" name="first_name" value="<?php echo e(old('first_name', Auth::user()->first_name)); ?>" required class="input">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="last_name" name="last_name" value="<?php echo e(old('last_name', Auth::user()->last_name)); ?>" required class="input">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" value="<?php echo e(Auth::user()->email); ?>" disabled class="input bg-slate-100">
                    </div>

                    <div>
                        <label for="phone" class="label">Telephone</label>
                        <input type="text" id="phone" name="phone" value="<?php echo e(old('phone', Auth::user()->phone)); ?>" required class="input">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isRemorqueur() || Auth::user()->isDepanneur()): ?>
                        <div>
                            <label for="zone_intervention" class="label">Zone d'intervention</label>
                            <input type="text" id="zone_intervention" name="zone_intervention" value="<?php echo e(old('zone_intervention', Auth::user()->zone_intervention)); ?>" class="input">
                        </div>

                        <div>
                            <label for="professional_info" class="label">Informations professionnelles</label>
                            <textarea id="professional_info" name="professional_info" rows="2" class="input"><?php echo e(old('professional_info', Auth::user()->professional_info)); ?></textarea>
                        </div>

                        <div>
                            <label for="bio" class="label">Biographie</label>
                            <textarea id="bio" name="bio" rows="3" class="input"><?php echo e(old('bio', Auth::user()->bio)); ?></textarea>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isRemorqueur()): ?>
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-slate-900 mb-4 flex items-center gap-2">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
                    ...
                    <form method="POST" action="<?php echo e(route('profile.remorque')); ?>" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="type" name="type" value="<?php echo e(old('type', $remorque->type ?? 'plateau')); ?>" required class="input">
                            </div>
                            <div>
                                <label for="capacity" class="label">Capacite</label>
                                <input type="text" id="capacity" name="capacity" value="<?php echo e(old('capacity', $remorque->capacity ?? '')); ?>" class="input">
                            </div>
                            <div>
                                <label for="immatriculation" class="label">Immatriculation</label>
                                <input type="text" id="immatriculation" name="immatriculation" value="<?php echo e(old('immatriculation', $remorque->immatriculation ?? '')); ?>" class="input">
                            </div>
                        </div>
                        <div>
                            <label for="informations" class="label">Informations</label>
                            <textarea id="informations" name="informations" rows="2" class="input"><?php echo e(old('informations', $remorque->informations ?? '')); ?></textarea>
                        </div>
                        <div class="flex justify-end">
                            <button type="submit" class="btn-primary">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isDepanneur()): ?>
                <div class="card p-6">
                    <h2 class="text-lg font-semibold text-slate-900 mb-4 flex items-center gap-2">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <label class="flex items-center gap-2 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 cursor-pointer">
                                    <input type="checkbox" name="services[]" value="<?php echo e($service->id); ?>" class="rounded text-orange-500" <?php echo e($assignedServices->contains($service->id) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\samaRemorque\senegal-towing\resources\views\profile\edit.blade.php ENDPATH**/ ?>