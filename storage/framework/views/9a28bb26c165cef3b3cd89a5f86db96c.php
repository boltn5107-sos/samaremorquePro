...
<head>
    ...
    <link rel="canonical" href="<?php echo e(url('/remorquage-senegal')); ?>">
    <link rel="alternate" hreflang="fr" href="<?php echo e(url('/remorquage-senegal')); ?>">
    <link rel="alternate" hreflang="fr-SN" href="<?php echo e(url('/remorquage-senegal')); ?>">
    <link rel="alternate" hreflang="x-default" href="<?php echo e(url('/remorquage-senegal')); ?>">
    ...
    <meta property="og:url" content="<?php echo e(url('/remorquage-senegal')); ?>">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [
                        ...
                        <a href="<?php echo e(route('guest.create')); ?>" class="card p-4 text-center hover:border-orange-300"><p class="font-semibold text-slate-900"><?php echo e($zone['name']); ?></p><p class="text-xs text-slate-500">Remorquage & depannage</p></a>
...
<?php /**PATH C:\xampp\htdocs\samaRemorque\senegal-towing\resources\views\pages\remorquage-senegal.blade.php ENDPATH**/ ?>