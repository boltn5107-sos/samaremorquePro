                        ...
                        <form method="POST" action="<?php echo e(route('remorqueur.intervention.status', $intervention)); ?>" class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" required class="input">
                                    <option value="remorqueur_en_route" <?php echo e($intervention->status === 'remorqueur_en_route' ? 'selected' : ''); ?>>En route</option>
                                    <option value="arrivee_sur_place" <?php echo e($intervention->status === 'arrivee_sur_place' ? 'selected' : ''); ?>>Arrive sur place</option>
                                    <option value="vehicule_pris_en_charge" <?php echo e($intervention->status === 'vehicule_pris_en_charge' ? 'selected' : ''); ?>>Vehicule pris en charge</option>
                                    <option value="intervention_terminee" <?php echo e($intervention->status === 'intervention_terminee' ? 'selected' : ''); ?>>Intervention terminee</option>
                                </select>
                            </div>
                            <div>
